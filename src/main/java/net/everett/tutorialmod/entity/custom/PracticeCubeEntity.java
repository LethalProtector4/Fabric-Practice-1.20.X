...
import net.everett.tutorialmod.entity.ai.PorcupineAttackGoal;
...
public class PracticeCubeEntity extends AnimalEntity {
    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;

    public PracticeCubeEntity(EntityType<? extends AnimalEntity> entityType, World world) { super(entityType, world); }
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new TemptGoal(this, 1.25D, Ingredient.ofItems(Items.OAK_PLANKS), false));
    ...
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.PRACTICE_CUBE.create(world);
    }
}
